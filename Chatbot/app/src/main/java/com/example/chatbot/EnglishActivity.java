...
public class EnglishActivity extends AppCompatActivity {
    ...
    private void startListening() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, "en-US"); // Hindi language
    ...
    private void chatWithHistory(String userMessage) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .readTimeout(60, TimeUnit.SECONDS)  // Increase read timeout for streaming responses
                .build();
        ...
        try {
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(EnglishActivity.this, "Network error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                }
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (!response.isSuccessful()) {
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(EnglishActivity.this, "Server error: " + response.code(), Toast.LENGTH_SHORT).show();
                        });
                        return;
                    }
