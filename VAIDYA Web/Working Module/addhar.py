...
import cv2
import pytesseract
from addhar_no_touching import get_values, send_to_json
...
def onetimescan():
    ...
    # Create JSON object
    json_data = create_json(regex_name, regex_gender, regex_dob, regex_aadhaar_number)
    
    return json_data

def create_json(regex_name, regex_gender, regex_dob, regex_aadhaar_number):
    ...
    json_string = {
        time_sec: {
            ...
            "gender": regex_gender,
            "dob": regex_dob,
            "aadhaar_number": regex_aadhaar_number,
        },
    }
    return json_string
